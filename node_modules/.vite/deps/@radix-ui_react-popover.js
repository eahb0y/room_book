...
var Popover = (props) => {
  ...
  const [hasCustomAnchor, setHasCustomAnchor] = React6.useState(false);
  ...
  return (0, import_jsx_runtime4.jsx)(Root2, { ...popperScope, children: (0, import_jsx_runtime4.jsx)(
    PopoverProvider,
    {
      ...
      hasCustomAnchor,
      onCustomAnchorAdd: React6.useCallback(() => setHasCustomAnchor(true), []),
      onCustomAnchorRemove: React6.useCallback(() => setHasCustomAnchor(false), []),
      modal,
      children
    }
  ) });
...
var PopoverContentModal = React6.forwardRef(
  (props, forwardedRef) => {
    const context = usePopoverContext(CONTENT_NAME2, props.__scopePopover);
    const contentRef = React6.useRef(null);
    const composedRefs = useComposedRefs(forwardedRef, contentRef);
    const isRightClickOutsideRef = React6.useRef(false);
    React6.useEffect(() => {
...
var PopoverContentNonModal = React6.forwardRef(
  (props, forwardedRef) => {
    const context = usePopoverContext(CONTENT_NAME2, props.__scopePopover);
...
var PopoverContentImpl = React6.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopePopover,
      trapFocus,
...
var PopoverClose = React6.forwardRef(
  (props, forwardedRef) => {
...
var PopoverArrow = React6.forwardRef(
  (props, forwardedRef) => {
